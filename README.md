...
* [libdragon-docker](https://github.com/anacierdem/libdragon-docker) ⭐ 37 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-06 - Dockerized toolchain based on [libdragon](https://github.com/DragonMinded/libdragon) ⭐ 1,221 | 🐛 98 | 🌐 C | 📅 2026-08-15
...
* [Dillonb's dgb-n64](https://github.com/Dillonb/n64) ⭐ 185 | 🐛 7 | 🌐 C++ | 📅 2026-08-15 - A low-level, accurate N64 emulator for Windows and Linux. It includes a CPU recompiler, and emulates RDP with Vulkan (via parallel-RDP).
...
* [Gopher64](https://github.com/gopher64/gopher64) ⭐ 1,210 | 🐛 15 | 🌐 Rust | 📅 2026-08-12 - An N64 emulator written in Rust by the developer of Simple64, able to already play some commercial games at decent speeds!
...
* [Not64](https://github.com/extremscorner/not64) ⭐ 366 | 🐛 1 | 🌐 C | 📅 2026-04-10 - A fork of Wii64
...
* [N64FlashcartMenu](https://github.com/Polprzewodnikowy/N64FlashcartMenu) ⭐ 442 | 🐛 52 | 🌐 C | 📅 2026-08-13 - Universal flashcart menu with aim to support most of the N64 flashcarts on the market

### Asset Conversion and Viewing

#### 3D

* [Fast64](https://github.com/Fast-64/fast64) ⭐ 522 | 🐛 76 | 🌐 Python | 📅 2026-08-15 - A Blender plugin to preview and export meshes as F3D display lists for decomp and homebrew projects.
...
* [libdragon](https://github.com/DragonMinded/libdragon) ⭐ 1,221 | 🐛 98 | 🌐 C | 📅 2026-08-15 - An open-source library for Nintendo 64 development
...
* [Super Mario 64](https://github.com/n64decomp/sm64) ⭐ 8,720 | 🐛 28 | 🌐 C | 📅 2024-02-04 - A **complete** decompilation of *Super Mario 64*
* [The Legend of Zelda: Ocarina of Time](https://github.com/zeldaret/oot) ⭐ 5,476 | 🐛 72 | 🌐 C | 📅 2026-08-15 - A **complete** decompilation of *The Legend of Zelda: Ocarina of Time*
* [The Legend of Zelda: Majora's Mask](https://github.com/zeldaret/mm) ⭐ 1,700 | 🐛 17 | 🌐 C | 📅 2026-08-14 - A **complete** decompilation of *The Legend of Zelda: Majora's Mask*
* [Paper Mario](https://github.com/pmret/papermario) ⭐ 1,602 | 🐛 33 | 🌐 C | 📅 2026-07-21 - A **complete** decompilation of *Paper Mario*
* [Mario Kart 64](https://github.com/n64decomp/mk64) ⭐ 1,290 | 🐛 33 | 🌐 C | 📅 2026-08-14 - A **complete** decompilation of *Mario Kart 64*
* [Diddy Kong Racing](https://github.com/DavidSM64/Diddy-Kong-Racing) ⭐ 413 | 🐛 3 | 🌐 C | 📅 2026-07-30 - An in-progress decompilation of *Diddy Kong Racing*
...
* [Pokémon Stadium](https://github.com/pret/pokestadium) ⭐ 197 | 🐛 4 | 🌐 C | 📅 2026-08-15 - An in-progress decompilation of *Pokémon Stadium*
...
* [F-Zero X](https://github.com/inspectredc/fzerox) ⭐ 101 | 🐛 2 | 🌐 C | 📅 2026-08-11 - An in-progress decompilation of *F-Zero X*
* [Pokémon Snap](https://github.com/ethteck/pokemonsnap) ⭐ 98 | 🐛 7 | 🌐 C | 📅 2026-08-15 - An in-progress decompilation of *Pokémon Snap*
...
* [Mischief Makers](https://github.com/drahsid/mischief-makers) ⭐ 69 | 🐛 3 | 🌐 C | 📅 2026-08-15 - An in-progress decompilation of *Mischief Makers*
...
* [Jet Force Gemini](https://github.com/ryan-myers/jet-force-gemini) ⭐ 46 | 🐛 3 | 🌐 C | 📅 2026-08-12 - An in-progress decompilation of *Jet Force Gemini*
...
* [Body Harvest](https://github.com/jaytheham/body-harvest-decompilation) ⭐ 37 | 🐛 2 | 🌐 C | 📅 2026-08-15 - An in-progress decompilation of *Body Harvest* in D (see also [DeltaniumIndustries/BodyHarvestDecomp](https://github.com/DeltaniumIndustries/BodyHarvestDecomp) ⚠️ Archived)
...
* [Pokémon Puzzle League](https://github.com/angheloalf/puzzleleague64) ⭐ 34 | 🐛 0 | 🌐 C | 📅 2026-08-15 - An in-progress decompilation of *Pokémon Puzzle League*
...
* [Quest 64](https://github.com/Rainchus/quest64-decomp) ⭐ 16 | 🐛 1 | 🌐 C | 📅 2026-02-03 - An in-progress decompilation of *Quest 64*
...
* [decomp-permuter](https://github.com/simonlindholm/decomp-permuter) ⭐ 210 | 🐛 48 | 🌐 Python | 📅 2026-08-05 - A tool to randomly permute C files to better match a target binary
...
* [N64LoaderWV](https://github.com/zeroKilo/N64LoaderWV) ⭐ 166 | 🐛 1 | 🌐 Java | 📅 2026-08-01 - Nintendo 64 ROM loader for the [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,367 | 🐛 1,908 | 🌐 Java | 📅 2026-08-13 reverse engineering tool
* [spimdisasm](https://github.com/decompollaborate/spimdisasm) ⭐ 77 | 🐛 7 | 🌐 Python | 📅 2026-08-06 - Matching MIPS disassembler API and front-ends with built-in instruction analysis
...
* [m3c](https://github.com/ethteck/m3c) ⭐ 13 | 🐛 3 | 🌐 Python | 📅 2024-05-01 - A tool to assist with N64 decompilation that runs [m2c](https://github.com/matt-kempster/m2c) ⭐ 622 | 🐛 62 | 🌐 Python | 📅 2026-08-11 and [decomp-permuter](https://github.com/simonlindholm/decomp-permuter) ⭐ 210 | 🐛 48 | 🌐 Python | 📅 2026-08-05 to try to automatically decompile functions
...
* [pyrite64](https://github.com/HailToDodongo/pyrite64) ⭐ 3,233 | 🐛 23 | 🌐 C++ | 📅 2026-08-06 - A game engine and editor using `libdragon` and `tiny3d` from C++

* [ClassiCube](https://github.com/ClassiCube/ClassiCube) ⭐ 2,028 | 🐛 560 | 🌐 C | 📅 2026-08-13 - A multi-platform Minecraft Classic / ClassiCube client with early N64 support, using `libdragon`
...
* [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 131 | 🐛 5 | 🌐 C | 📅 2026-08-14 - A 4-layer nano-GPT neural network (819K parameters) running natively on the N64's MIPS R4300i FPU, believed to be the first LLM on Nintendo 64 hardware
